<template>
  ...
  <el-menu
    ...
    router
    class="h-screen min-w-64 bg-white-custom text-[var(--text-color)]font-semibold"
    active-text-color="#958BE8"
  >
    <!-- Logo -->
    <div class="py-4 mb-4">
      <router-link to="/">
    ...
    <el-menu-item index="/admin/cinema-manager" class="menu-item">
      <i class="fa-solid fa-building-columns"></i>
      <span>Cinema</span>
    </el-menu-item>
    <el-menu-item index="/admin/movie-manager" class="menu-item">
      <i class="fa-solid fa-film"></i>
      <span>Movie</span>
    </el-menu-item>
    <el-menu-item index="/admin/showtime-manager" class="menu-item">
      <i class="fa-solid fa-video"></i>
      <span>Showtime</span>
    </el-menu-item>
    <el-menu-item index="/admin/room-manager" class="menu-item">
      <i class="fa-solid fa-door-open"></i>
      <span>Room</span>
    </el-menu-item>
    <el-menu-item index="/admin/seat-manager" class="menu-item">
...
.el-menu-item {
  border-radius: 999px; /* Đảm bảo bo tròn hoàn toàn */
  transition: all 0.3s ease-in-out;
  margin: 5px 0;
}
.el-menu-item:hover {
  background-color: #958be8 !important; /* Màu tím custom */
  color: white !important; /* Đổi màu chữ để dễ nhìn */
}
.el-menu-item.is-active {
  background-color: #958be8 !important; /* Màu tím khi active */
